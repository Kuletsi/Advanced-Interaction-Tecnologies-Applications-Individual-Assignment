...
# Introduction
Στα πλαίσια του μαθήματος Προηγμένες τεχνολογίες αλληλεπίδρασης και εφαρμογές ασχοληθήκαμε με την γλώσσα προγραμματισμού και το προγράμματος δικό περιβάλλον Processing. 

# Summary
Σκοπός μας ήταν να μάθουμε πως να Συγκεκριμένα υλοποιήσαμε παραδείγματα από το βιβλίο Learning Processing 2nd Edition, που είχαν να κάνουν με την χρήση βίντεο, εικόνων, QR κωδικών, την δημιουργία objects, και της επεξεργασίας των παραπάνω. Επίσης μάθαμε να κατεβάζουμε και χρησιμοποιήσαμε πολλές βιβλιοθήκες, που βοήθησαν πολύ στο να φτιάξουμε τα παραδοτέα. Τέλος, στα πλαίσια του bonus συνδέσαμε τις γνώσεις που είχαμε αποκτήσει με τις κιναισθητικές διεπαφές, με την χρήση μιας κάμερας kinect. 
...
# Bonus 1 <br> Σε συνεργασία με την <a href="https://github.com/cgalani">Χριστίνα Γαλάνη</a> και τον <a href="https://github.com/dpsd19044">Δημήτρη Καμπεράκη</a>
...
# Bonus 2 <br> Σε συνεργασία με την <a href="https://github.com/cgalani">Χριστίνα Γαλάνη</a> και τον <a href="https://github.com/dpsd19044">Δημήτρη Καμπεράκη</a>
...
Το processing είναι ένα παρά πολύ δημιουργικό εργαλείο, το οποίο αν γνωρίζεις πως να το χειριστείς μπορείς να φτιάξεις παρά πολλά πράγματα. Τα παραδοτέα ήταν μέτρια σε δυσκολία, δηλαδή ήταν αρκετά εύκολα υλοποιήσιμα αλλά όχι τόσο εύκολα ώστε να μην νιώθεις ευχαρίστηση όταν καταφέρεις να το κανείς. Επίσης η ευκολία τους πολλές φορές άφηνε περιθώριο πειραματισμού, ώστε τα παραδοτέα να είναι πιο personalized. Οι μπόνους εργασίες με την κάμερα kinect ήταν ιδιαίτερα ενδιαφέρον επειδή είδαμε πως μπορούμε σε κάτι πρακτικό να εντάξουμε τις γνώσεις που αποκτήσαμε.
